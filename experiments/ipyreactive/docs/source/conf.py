...
# -*- coding: utf-8 -*-
#
# ipyreactive documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyreactive', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyreactivedoc'
...
latex_documents = [
    (master_doc, 'ipyreactive.tex', 'ipyreactive Documentation',
     'Datalayer', 'manual'),
]
