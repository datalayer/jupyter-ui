...
The bottom-left blue icon should now show `Dev Container: Jupyter UI`. You can now open a `Terminal` from VS Code and run `npm start`. Double check with a few commands.
