...
This will consume kernels from the Datalayer development free servers in the cloud. If you need your own server (on your local machine or on your cloud), read more on [Jupyter Server](/deployments/jupyter-server)
