...
1. [With Conda](/develop/conda)
1. [With VS Code Devcontainers](/develop/devcontainers)
...
You are now ready to follow the [quickstart guide](/develop/quickstart) to create your first Jupyter React application.
