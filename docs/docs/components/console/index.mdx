...
import { StorybookView } from '../StorybookView.js';
...
<StorybookView 
    story='components-console--default'
/>
...
<StorybookView 
    story='components-console--lite-python'
/>
...
<StorybookView 
    story='components-console--lite-javascript'
/>
