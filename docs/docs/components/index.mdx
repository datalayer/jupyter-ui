...
| [JupyterLab App](/components/jupyterlab-app) | Full JupyterLab as a React component |
...
- **[@datalayer/jupyter-lexical](/components/lexical)** - Rich document editor with Jupyter cells
- **[@datalayer/jupyter-embed](/components/embed)** - Easy embedding for any website
