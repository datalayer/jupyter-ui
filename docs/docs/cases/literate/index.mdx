...
A a developer, you can create your own custom data product `a-la-google-docs` as shown below. Your custom `Literate Notebook` can be shipped as a standalone component, as Jupyter Notebook, JupyterLab and as Visual Studio Code extension.
