...
Setup your [development environment](/docs/develop/setup).
...
Therefor, we ask to pin the yarn resolutions. Add [this block](https://github.com/datalayer/jupyter-ui/blob/main/package.json#L76-L184) in your package.json.
