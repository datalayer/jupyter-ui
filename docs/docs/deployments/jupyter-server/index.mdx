...
To connect to a Jupyter Server, you have to define the URL for HTTP and WebSocket, as well as a Token.

Those properties can be provided in the [Jupyter Context](/docs/components/context)
...
Alternatively, you can set thoses values in the host HTML (index.html) a `script` tag in the head section.
...
<details>
  ...
  <summary>Use the following at your own risk!.</summary>
