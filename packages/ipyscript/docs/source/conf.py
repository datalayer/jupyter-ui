...
# -*- coding: utf-8 -*-
#
# ipyscript documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyscript', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipyscriptdoc'
...
latex_documents = [
    (master_doc, 'ipyscript.tex', 'ipyscript Documentation',
     'Datalayer', 'manual'),
]
