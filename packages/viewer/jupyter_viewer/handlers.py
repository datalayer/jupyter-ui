...
class JupyterViewerHandler(JupyterHandler):
    """JupyterViewerHandler"""
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_viewer", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_viewer", "echo")
    handlers = [
        (route_pattern, JupyterViewerHandler),
