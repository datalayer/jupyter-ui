 ...
 */
export const IKernels = new Token<IKernels>('@datalayer/jupyterlite-kernel:IKernels');
 ...
 */
export const IKernelSpecs = new Token<IKernelSpecs>('@datalayer/jupyterlite-kernel:IKernelSpecs');
