...
export const outputActions = {
  source: actionCreator<OutputState.ISource>(OutputActionType.SOURCE),
  dataset: actionCreator<OutputState.IDataset>(OutputActionType.DATASET),
  execute: actionCreator<OutputState.IExecute>(OutputActionType.EXECUTE),
  setSource: actionCreator<OutputState.IExecute>(OutputActionType.SET_SOURCE),
  grade: actionCreator<OutputState.IGrade>(OutputActionType.GRADE),
};
...
export const outputReducer = reducerWithInitialState(outputInitialState)
  .case(
    ...
    (state: IOutputsState, source: OutputState.ISource) => {
  ...
  .case(
    ...
    (state: IOutputsState, dataset: OutputState.IDataset) => {
  ...
  .case(
    ...
    (state: IOutputsState, execute: OutputState.IExecute) => {
  ...
  .case(
    ...
    (state: IOutputsState, setSource: OutputState.ISource) => {
  ...
  .case(
    outputActions.grade,
    (state: IOutputsState, grade: OutputState.IGrade) => {
