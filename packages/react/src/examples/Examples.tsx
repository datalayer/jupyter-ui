...
const EXAMPLES: Array<{ name: string; path: string }> = [
  ...
  { name: 'Marimo Notebook', path: 'MarimoNotebook' },
  { name: 'Marimo Reactive Jupyter Notebook', path: 'MarimoReactiveNotebook' },
  { name: 'Marimo Cell', path: 'MarimoCell' },
  { name: 'Marimo Output', path: 'MarimoOutput' },
  { name: 'Marimo Kernel', path: 'MarimoKernel' },
  ...
  { name: 'Notebook Actions', path: 'NotebookActions' },
  ...
  { name: 'Notebook Primer Theme Example', path: 'NotebookPrimerThemeExample' },
...
const importExample = (path: string): Promise<unknown> => {
  const modules: Record<string, () => Promise<unknown>> = {
    ...
    MarimoNotebook: () => import('./MarimoNotebook'),
    MarimoReactiveNotebook: () => import('./MarimoReactiveNotebook'),
    MarimoCell: () => import('./MarimoCell'),
    MarimoOutput: () => import('./MarimoOutput'),
    MarimoKernel: () => import('./MarimoKernel'),
    ...
    NotebookActions: () => import('./NotebookActions'),
    ...
    NotebookPrimerThemeExample: () => import('./NotebookPrimerThemeExample'),
