...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      './coincident.worker.js': path.resolve(
        __dirname,
        'src/jupyter/lite/pyodide-kernel/coincident.worker.ts'
      ),
      './comlink.worker.js': path.resolve(
        __dirname,
        'src/jupyter/lite/pyodide-kernel/comlink.worker.ts'
      ),
    },
    fallback: {
