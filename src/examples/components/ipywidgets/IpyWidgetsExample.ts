import IpyWidgetManager from '../../../ipywidgets/IpyWidgetsManager';

class IPyWidgetsExample {
  ...
  constructor(el: HTMLElement) {
    ...
    manager
      ...
      .then((models: any) =>
        manager.create_view(
          models.find(
            (element: any) => element.model_id == '8621699ecc804983a612f09b7dfe806b'
          )
        )
      )
...
export default IPyWidgetsExample;
